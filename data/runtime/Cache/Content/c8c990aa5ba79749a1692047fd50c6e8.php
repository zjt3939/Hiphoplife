...
<body class="J_scroll_fixed">
	<div class="wrap J_check_wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="javascript:;">所有涂鸦</a></li>
			<li><a href="<?php echo U('AdminImageManage/add',array('term'=>empty($term['term_id'])?'':$term['term_id']));?>" target="_self">添加涂鸦</a></li>
		</ul>
		<form class="J_ajaxForm" action="" method="post">
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($ImageData)): foreach($ImageData as $key=>$do): ?><tr>
						<td><?php echo ($do['name']); ?></td>
						<td><?php echo ($do['author']); ?></td>
						...
						<td>
						<a href="<?php echo U('AdminImageManage/edit',array('id'=>$do['id']));?>">修改</a> | 
						<a href="<?php echo U('AdminImageManage/delete',array('id'=>$do['id']));?>" class="J_ajax_del">删除</a></td>
