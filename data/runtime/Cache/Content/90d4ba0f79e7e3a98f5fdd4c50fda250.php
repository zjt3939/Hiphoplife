...
<div class="wrap J_check_wrap">
  <ul class="nav nav-tabs">
     <li><a href="<?php echo U('AdminImageManage/index');?>">所有涂鸦</a></li>
     <li class="active"><a href="<?php echo U('AdminImageManage/add');?>">添加涂鸦</a></li>
  </ul>
  <form name="myform" id="myform"  action="<?php echo U('AdminImageManage/add_post');?>" method="post" class="form-horizontal J_ajaxForms" enctype="multipart/form-data">
  <div class="col-auto">
    <div class="table_full">
      ...
      <table width="100%" cellpadding="2" cellspacing="2">
            <tr>
              <th width="80">涂鸦名称</th>
              <td>
              	<input type="text"  name="name" id="name" value="" style="color:" class="input input_hd J_title_color" placeholder="请输入涂鸦名称" onkeyup="strlen_verify(this, 'title_len', 160)" />
              	<span class="must_red">*</span>
              </td><tr>
              <th width="80">作者</th>
              <td>
              	<input type="text"  name="author" id="author" value="" style="color:" class="input input_hd J_title_color" placeholder="请输入作者名称" onkeyup="strlen_verify(this, 'title_len', 160)" />
              	<span class="must_red">*</span>
              </td>
            </tr>
            <tr>
  ...
  <div class="form-actions">
        ...
        <a class="btn" href="<?php echo U('AdminImageManage/index');?>">返回</a>
  </div>
 </form>
</div>
	...
	$('.file').hide();
	 Wind.use('validate', 'ajaxForm', 'artDialog', function () {
	        ...
	        form.validate({
	            ...
	            //验证未通过提示消息
	            messages: {'name':{required:'涂鸦名称不能为空'},'category_id':{required:'涂鸦类型不能为空'},'gather_id':{required:'涂鸦专辑不能为空'},'keywords':{required:'关键字不能为空'}},
	            //给未通过验证的元素加效果,闪烁等
	            highlight: false,
	            //是否在获取焦点时验证
	            onfocusout: false,
										...
										button:[
											{
												...
												name: '返回列表',
												callback:function(){
													location.href="<?php echo U('AdminImageManage/index');?>";
													return true;
												}
											}
										]
