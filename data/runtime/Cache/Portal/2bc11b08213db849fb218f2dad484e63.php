  ...
  <div class="col-auto">
    <div class="table_full">
      <table class="table table-bordered">
           ...
           <!--  <tr>
             <th width="80">类型</th>
             <td><input type='text' name='post[type]' id='type' value='' style='width:400px'   class='input' placeholder='请输如栏目值'></td>
           </tr> -->
            <tr>
              <th width="80">摘要 </th>
            ...
            <tr>
              ...
              <script type="text/plain" id="content" name="post[post_content]"></script>
                ...
                <script type="text/javascript"  src="/hiphoplife/statics/js/ueditor/ueditor.config.js"></script>
                <script type="text/javascript"  src="/hiphoplife/statics/js/ueditor/ueditor.all.min.js"></script>
				</td>
            </tr>
